...
<div class="centered-form">
	<div class="centered-form__form">
		...
		<div class="form-field">
			...
			<input type="text" name="phone" v-model="username"/>
		</div>
		<div class="form-field">
